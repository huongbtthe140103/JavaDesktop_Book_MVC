 ...
 * @author tvhtr
 */
public class BookController extends javax.swing.JFrame {

    /**
     * Creates new form BookController
     */
    DBConnection dBConn = null;
    DAOBook daoBook = null;

    public BookController() {
        initComponents();
        dBConn = new DBConnection();
        daoBook = new DAOBook(dBConn);
//        this.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if (rs.next()) {
                JOptionPane.showMessageDialog(this, "Duplicated Key");
                return;
            }
        ...
        String st1 = txtQuantity.getText();
        //check st1 is number
        int quantity = Integer.parseInt(st1);
        st1 = txtPrice.getText();
        //check st1
        double price = Double.parseDouble(st1);
        Book book = new Book(id, name, quantity, price);
        int n = daoBook.insertBook(book);
        if (n > 0) {
